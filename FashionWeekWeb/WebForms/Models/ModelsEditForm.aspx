<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModelsEditForm.aspx.cs" Inherits="WebForms_Models_ModelsEditForm" %>
...
<body>
    ...
    <div class="SmallFormDiv">
        ...
        <asp:CheckBox ID="checkBoxSG" runat="server"  Enabled="false" />
