<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModelsForm.aspx.cs" Inherits="WebForms_Models_ModelsForm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="modelsHead" runat="server">
    <title id="pageTitle">The Models</title>
...
<body>
    ...
    <form id="ModelsForm" runat="server">
    <div>
        <asp:Label ID="labelTitle" runat="server" Text="The Models" />
        <asp:ListBox 
            ID="listBoxItems" 
            runat="server" 
            AutoPostBack="true">
