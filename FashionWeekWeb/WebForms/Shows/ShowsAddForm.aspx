<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowsAddForm.aspx.cs" Inherits="WebForms_Shows_ShowsAddForm" %>
...
<body>
    ...
    <form id="showsAddForm" runat="server">
    <asp:Label ID="labelPageTitle" runat="server" Text="Register New Show" />
