<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgenciesEditForm.aspx.cs" Inherits="WebForms_Agencies_AgenciesEditForm" %>
...
<body>
    ...
    <asp:Label ID="labelPageTitle" runat="server" Text="Edit Agency" />
    <div class="SmallFormDiv">
        <asp:Label ID="labelRegNum" CssClass="LeftSide" runat="server" Text="Registration Number:"></asp:Label>
        <asp:TextBox ID="textBoxRegNum" CssClass="RightSide" Enabled="true" runat="server"></asp:TextBox>
        ...
        <asp:Label ID="labelModels" CssClass="RightSide" runat="server" Text="Available Models:"></asp:Label>
        <asp:CheckBoxList ID="boxModels" CssClass="RightSide" runat="server"></asp:CheckBoxList>
        <asp:CheckBox ID="checkBoxInt" runat="server" Enabled="false" AutoPostBack="true" />
        <label id="labelInt" class="LeftSide" for="checkBoxInt" runat="server">International Agency</label>
